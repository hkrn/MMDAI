...
function(link_glew target)
  if(VPVL2_OPENGL_RENDERER AND VPVL2_LINK_GLEW AND NOT VPVL2_ENABLE_GLES2)
...
function(find_sfml)
  if(VPVL2_OPENGL_RENDERER AND VPVL2_LINK_SFML)
...
function(find_icu target)
  if(VPVL2_OPENGL_RENDERER)
    ...
    set(ICU_INCLUDE_UC_LOCAL_DIR "${CMAKE_CURRENT_SOURCE_DIR}/../icu-src/source/common")
    set(ICU_INCLUDE_I18N_LOCAL_DIR "${CMAKE_CURRENT_SOURCE_DIR}/../icu-src/source/i18n")
    set(ICU_LIBRARY_LOCAL_DIR "${CMAKE_CURRENT_SOURCE_DIR}/../icu-src/${ICU_BUILD_TYPE}/lib")
    find_library(ICU_LIBRARY_I18N icui18n PATHS ${ICU_LIBRARY_LOCAL_DIR})
    find_library(ICU_LIBRARY_UC icuuc PATHS ${ICU_LIBRARY_LOCAL_DIR})
    find_library(ICU_LIBRARY_DATA icudata PATHS ${ICU_LIBRARY_LOCAL_DIR})
    find_path(ICU_INCLUDE_UC_DIR unicode/unistr.h PATHS ${ICU_INCLUDE_UC_LOCAL_DIR})
    find_path(ICU_INCLUDE_I18N_DIR unicode/regex.h PATHS ${ICU_INCLUDE_I18N_LOCAL_DIR})
