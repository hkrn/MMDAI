...
function(vpvl2_find_gl_runtime)
  if(VPVL2_ENABLE_EXTENSIONS_RENDERCONTEXT)
    if(NOT $ENV{MESA3D_BINARY_DIR} STREQUAL "" AND NOT $ENV{MESA3D_INCLUDE_DIR} STREQUAL "")
      find_library(OPENGL_gl_mesa_LIBRARY mesa PATH_SUFFIXES mesa PATHS $ENV{MESA3D_BINARY_DIR} NO_DEFAULT_PATH)
      find_library(OPENGL_gl_osmesa_LIBRARY osmesa PATH_SUFFIXES mesa/drivers/osmesa PATHS $ENV{MESA3D_BINARY_DIR} NO_DEFAULT_PATH)
      set(OPENGL_gl_LIBRARY "${OPENGL_gl_mesa_LIBRARY} ${OPENGL_gl_osmesa_LIBRARY}")
      find_path(OPENGL_INCLUDE_DIR osmesa.h PATH_SUFFIXES include/GL GL PATHS $ENV{MESA3D_INCLUDE_DIR} NO_DEFAULT_PATH)
