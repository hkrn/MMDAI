...
function(vpvl2_add_sdl_renderer)
  if(VPVL2_LINK_SDL2)
    get_install_directory(SDL_INSTALL_DIR "SDL-src")
...
function(vpvl2_add_glfw_renderer)
  if(VPVL2_LINK_GLFW)
    ...
    find_library(GLFW_LIBRARY glfw3 PATH_SUFFIXES lib64 lib32 lib PATHS ${GLFW_INSTALL_DIR} NO_DEFAULT_PATH)
