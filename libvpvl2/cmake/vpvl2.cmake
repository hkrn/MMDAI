...
function(vpvl2_find_regal)
  if(VPVL2_LINK_REGAL)
    ...
    if(MSVC)
      find_library(REGAL_LIBRARY NAMES regal32 PATHS ${REGAL_INSTALL_DIR}/build/win32/vs2010/regal/${CMAKE_BUILD_TYPE}/win32 NO_DEFAULT_PATH)
    elseif(APPLE)
      find_library(REGAL_LIBRARY NAMES Regal PATH_SUFFIXES lib/darwin PATHS ${REGAL_INSTALL_DIR} NO_DEFAULT_PATH)
    elseif(${CMAKE_SYSTEM_NAME} STREQUAL "Linux")
      find_library(REGAL_LIBRARY NAMES Regal PATH_SUFFIXES lib/linux PATHS ${REGAL_INSTALL_DIR} NO_DEFAULT_PATH)
    else()
...
function(vpvl2_add_sfml_renderer)
  if(VPVL2_LINK_SFML)
    ...
    find_library(SFML2_GRAPHICS_LIBRARY NAMES sfml-graphicss-s sfml-graphics sfml-graphics-s-d sfml-graphics-d PATH_SUFFIXES lib64 lib32 lib PATHS ${SFML2_INSTALL_DIR} NO_DEFAULT_PATH)
    find_library(SFML2_SYSTEM_LIBRARY NAMES sfml-system-s sfml-system sfml-system-s-d sfml-system-d PATH_SUFFIXES lib64 lib32 lib PATHS ${SFML2_INSTALL_DIR} NO_DEFAULT_PATH)
    find_library(SFML2_WINDOW_LIBRARY NAMES sfml-window-s sfml-window sfml-window-s-d sfml-window-d PATH_SUFFIXES lib64 lib32 lib PATHS ${SFML2_INSTALL_DIR} NO_DEFAULT_PATH)
