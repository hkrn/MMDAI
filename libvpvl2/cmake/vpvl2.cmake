...
function(vpvl2_find_tbb)
  if(VPVL2_LINK_INTEL_TBB)
    ...
    if(WIN32 AND CMAKE_BUILD_TYPE STREQUAL "Debug")
      ...
      string(TOLOWER ${CMAKE_BUILD_TYPE} CMAKE_BUILD_TYPE_TOLOWER)
      find_library(TBB_LIBRARY NAMES tbb PATHS "${TBB_SOURCE_DIRECTORY}/build/${tbb_build_prefix}_${CMAKE_BUILD_TYPE_TOLOWER}" NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH)
    endif()
...
function(vpvl2_find_zlib)
  if(VPVL2_ENABLE_EXTENSIONS_ARCHIVE)
    if(NOT APPLE)
      ...
      __get_source_path(ZLIB_SOURCE_DIRECTORY "zlib-src")
      __get_build_directory(ZLIB_BUILD_DIRECTORY)
      __get_local_library_path(ZLIB_LIBRARY_LOCAL_DIR ZLIB_SOURCE_DIRECTORY)
      ...
      find_path(ZLIB_INCLUDE_CONFIG_DIR NAMES zconf.h PATHS "${ZLIB_SOURCE_DIRECTORY}/${ZLIB_BUILD_DIRECTORY}" NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH)
    endif()
