...
function(vpvl2_find_icu)
  if(VPVL2_ENABLE_EXTENSIONS_STRING)
    if(MSVC)
      get_source_directory(ICU_INSTALL_DIR "icu-src")
    else()
...
function(vpvl2_link_mojo target)
  if(MOJO_SHADER_LIBRARY)
    target_link_libraries(${target} ${MOJO_SHADER_LIBRARY})
  endif()
endfunction()

function(vpvl2_find_mojo)
  if(VPVL2_ENABLE_EXTENSIONS_EFFECT)
    get_source_directory(MOJO_SHADER_SOURCE_DIRECTORY "mojoshader-src")
    get_build_directory(MOJO_SHADER_BUILD_DIRECTORY MOJO_SHADER_SOURCE_DIRECTORY)
    find_path(MOJO_SHADER_INCLUDE_DIR NAMES mojoshader.h PATHS ${MOJO_SHADER_SOURCE_DIRECTORY} NO_DEFAULT_PATH)
    find_library(MOJO_SHADER_LIBRARY mojoshader PATHS ${MOJO_SHADER_BUILD_DIRECTORY} NO_DEFAULT_PATH)
    include_directories(${MOJO_SHADER_INCLUDE_DIR})
  endif()
endfunction()
