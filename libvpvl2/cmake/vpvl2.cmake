...
function(vpvl2_detect_compiler_features)
  if(VPVL2_ENABLE_CXX11)
    ...
    check_cxx_source_compiles("class C final {} c; int main() { return 0; }" VPVL2_HAS_CXX11_DECL_FINAL)
    check_cxx_source_compiles("class C { int m() noexcept { return 0; } } c; int main() { return 0; }" VPVL2_HAS_CXX11_DECL_NOEXCEPT)
    check_cxx_source_compiles("thread_local static bool b = true; int main() { return 0; }" VPVL2_HAS_CXX11_DECL_THREAD_LOCAL)
...
function(vpvl2_set_warnings)
  ...
  elseif(MSVC)
    ...
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} /EHsc /wd4068 /wd4819")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /EHsc /wd4068 /wd4355 /wd4819")
...
function(vpvl2_find_bullet)
  ...
  message(STATUS "Added Bullet Physics")
endfunction()
...
function(vpvl2_find_assimp)
  if(VPVL2_LINK_ASSIMP3 OR VPVL2_LINK_ASSIMP)
    ...
    if(VPVL2_LINK_ASSIMP3)
      ...
      message(STATUS "Added libassimp3")
    elseif(VPVL2_LINK_ASSIMP)
      ...
      message(STATUS "Added libassimp2")
    endif()
...
function(vpvl2_find_icu)
  if(VPVL2_ENABLE_EXTENSIONS_STRING)
    ...
    message(STATUS "Added ICU a.k.a International Components for Unicode")
  endif()
endfunction()
...
function(vpvl2_find_tbb)
  if(VPVL2_LINK_INTEL_TBB)
    ...
    message(STATUS "Added TBB a.k.a Threading Building Blocks")
  endif()
endfunction()
...
function(vpvl2_find_alsoft)
  if(VPVL2_ENABLE_EXTENSIONS_APPLICATIONCONTEXT)
    ...
    message(STATUS "Added OpenAL soft")
  endif()
endfunction()
...
function(vpvl2_find_gl_runtime)
  if(VPVL2_ENABLE_EXTENSIONS_APPLICATIONCONTEXT)
    ...
    elseif(VPVL2_ENABLE_GLES2)
      find_path(OPENGL_INCLUDE_DIR gl2.h PATHS include/OpenGLES2 $ENV{EMSCRIPTEN}/system/include/GLES2 include/GLES2)
      if(NOT VPVL2_ENABLE_LAZY_LINK)
...
function(vpvl2_find_cl_runtime)
  if(VPVL2_ENABLE_OPENCL)
    ...
    message(STATUS "Activated OpenCL")
  endif()
endfunction()
...
function(vpvl2_find_glm)
  ...
  message(STATUS "Added GLM a.k.a OpenGL Mathematics")
endfunction()
...
function(vpvl2_find_glog)
  ...
  message(STATUS "Added google-glog")
  endif()
endfunction()
...
function(vpvl2_find_hlslxc)
  ...
  message(STATUS "Added HLSL Cross Compiler")
  endif()
endfunction()
...
function(vpvl2_find_atb)
  if(VPVL2_LINK_ATB)
    ...
    message(STATUS "Added AntTweakBar")
  endif()
endfunction()
...
function(vpvl2_find_freeimage)
  if(VPVL2_LINK_FREEIMAGE)
    ...
    message(STATUS "Added FreeImage library")
  endif()
endfunction()
