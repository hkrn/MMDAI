...
function(vpvl2_find_tbb)
  if(VPVL2_LINK_INTEL_TBB)
    ...
    if(WIN32 AND CMAKE_BUILD_TYPE STREQUAL "Debug")
      ...
      find_library(TBB_LIBRARY NAMES tbb PATH_SUFFIXES lib PATHS ${TBB_SOURCE_DIRECTORY} NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH)
      find_library(TBB_MALLOC_LIBRARY NAMES tbbmalloc PATH_SUFFIXES lib PATHS ${TBB_SOURCE_DIRECTORY} NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH)
      if(WIN32)
        find_library(TBB_PROXY_LIBRARY NAMES tbbproxy PATH_SUFFIXES lib PATHS ${TBB_SOURCE_DIRECTORY} NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH)
        find_library(TBB_MALLOC_PROXY_LIBRARY NAMES tbbmalloc_proxy PATH_SUFFIXES lib PATHS ${TBB_SOURCE_DIRECTORY} NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH)
      endif()
    endif()
...
function(vpvl2_find_zlib)
  if(VPVL2_ENABLE_EXTENSIONS_ARCHIVE)
    if(NOT APPLE)
      ...
      find_library(ZLIB_LIBRARY NAMES z PATHS ${ZLIB_LIBRARY_LOCAL_DIR} NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH)
      find_path(ZLIB_INCLUDE_DIR NAMES zlib.h PATHS ${ZLIB_SOURCE_DIRECTORY} NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH)
      find_path(ZLIB_INCLUDE_CONFIG_DIR NAMES zconf.h PATHS ${ZLIB_BUILD_DIRECTORY} NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH)
    endif()
