...
void TestProject::testBoneAnimation(const IMotion *motion)
{
    ...
    QCOMPARE(ba.frameAt(0)->timeIndex(), IKeyframe::TimeIndex(1));
    ...
    QCOMPARE(ba.frameAt(1)->timeIndex(), IKeyframe::TimeIndex(2));
...
void TestProject::testMorphAnimation(const IMotion *motion)
{
    ...
    QCOMPARE(ma.frameAt(0)->timeIndex(), IKeyframe::TimeIndex(1));
    QVERIFY(ma.frameAt(0)->name()->equals(&bar));
    QCOMPARE(ma.frameAt(0)->weight(), IMorph::WeightPrecision(0));
    QCOMPARE(ma.frameAt(1)->timeIndex(), IKeyframe::TimeIndex(2));
    QVERIFY(ma.frameAt(1)->name()->equals(&baz));
    QCOMPARE(ma.frameAt(1)->weight(), IMorph::WeightPrecision(1));
}
...
void TestProject::testCameraAnimation(const IMotion *motion)
{
    ...
    QCOMPARE(ca.frameAt(0)->timeIndex(), IKeyframe::TimeIndex(1));
    ...
    QCOMPARE(ca.frameAt(1)->timeIndex(), IKeyframe::TimeIndex(2));
...
void TestProject::testLightAnimation(const IMotion *motion)
{
    ...
    QCOMPARE(la.frameAt(0)->timeIndex(), IKeyframe::TimeIndex(1));
    QCOMPARE(la.frameAt(0)->color(), Vector3(1, 2, 3));
    QCOMPARE(la.frameAt(0)->direction(), Vector3(1, 2, 3));
    QCOMPARE(la.frameAt(1)->timeIndex(), IKeyframe::TimeIndex(2));
