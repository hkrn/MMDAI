...
if(ALTYPE STREQUAL "ios")
  set(GZDESC "zlib library")
  set(ZCAT "\"\"")
  set(USE_MIC ON BOOL)
  add_definitions(-DHAVE_ZLIB)
elseif(ALTYPE STREQUAL "coreaudio")
  find_library(CORESERVICES_FRAMEWORK CoreServices)
  find_library(COREAUDIO_FRAMEWORK CoreAudio)
  find_library(AUDIOUNIT_FRAMEWORK AudioUnit)
  find_library(AUDIOTOOLBOX_FRAMEWORK AudioToolbox)
  list(APPEND libsent_adin_source "libsent/src/adin/adin_mic_darwin_coreaudio.m")
  list(APPEND LIBSENT_DEPENDS_LIBRARY ${CORESERVICES_FRAMEWORK} ${COREAUDIO_FRAMEWORK} ${AUDIOUNIT_FREMEWORK} ${AUDIOTOOLBOX_FRAMEWORK})
  set(USE_MIC ON BOOL)
elseif(ALTYPE STREQUAL "portaudio" OR ALTYPE MATCHES "pa-*")
  include(CheckLibraryExists)
